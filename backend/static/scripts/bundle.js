(() => {
  ...
  (s.d = (t, e) => {
    ...
    (() => {
      ...
      for (let t = 0; t < h.length; t++) u[h.charCodeAt(t)] = t;
      ...
      wt &&
        ...
        vt.on(
          ...
          ({ gametitle: t, count: e, game_id: s, ongoing: n }) => {
            ...
            (r.style.backgroundColor = "rgb(59, 245, 149)"),
      ...
      vt.on(bt.START_GAME, ({ top_deck: t, top_discard: e, players: s }) => {
        ...
        vt.on(bt.PLAY_CARD, ({ top_discard: t, players: e }) => {
          (document.getElementById("discard-img-id").src = Et + t), At(e);
        }),
        vt.on(bt.DRAW_CARD, ({ top_deck: t, players: e }) => {
          (document.getElementById("deck-img-id").src = Et + t), At(e);
        }),
