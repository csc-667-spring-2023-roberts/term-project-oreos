(() => {
  ...
  (s.d = (t, e) => {
    ...
    (() => {
      ...
      function q() {}
      const j = null != new I({ xdomain: !1 }).responseType;
      class M extends m {
        constructor(t, e) {
          super(),
            E(this, e),
        ...
        V = {
          websocket: class extends w {
            ...
            doOpen() {
              ...
              try {
                this.ws = U ? new H(t, e, s) : e ? new H(t, e) : new H(t);
              } catch (t) {
      ...
      function Z(t) {
        return (
          (z && (t instanceof ArrayBuffer || J(t))) ||
          (Q && t instanceof Blob) ||
          (X && t instanceof File)
        );
      }
      ...
      Object.assign(mt, { Manager: ft, Socket: dt, io: mt, connect: mt });
      var gt = s(432);
      ...
      const bt = mt(),
        ...
        _t = "../images/",
        Et = JSON.parse(localStorage.getItem("user"));
      bt.emit(gt.JOIN_GAME, { game_id: vt, user: Et }),
        bt.on(gt.REDIRECT_TO_GAME_ROOM, ({ game_id: t }) => {
          window.location.href = `/games/${t}`;
        }),
        bt.on(
          gt.CREATE_GAME,
          ({ gametitle: t, count: e, user_id: s, game_id: n, ongoing: i }) => {
            let r = document.getElementById("games-list-id");
            if (!r) return;
            let o = document.createElement("li");
            (o.innerHTML = `Title: <a href="/waitingroom/${n}">${t}</a>, Players: ${e}, Started: ${i}`),
              r.appendChild(o);
          }
        ),
        bt.on(gt.CHAT, ({ message: t, username: e }) => {
      ...
      bt.on(gt.START_GAME, ({ top_deck: t, top_discard: e, players: s }) => {
        ...
        bt.on(
          gt.PLAY_CARD,
          ({ card_id: t, game_id: e, user_id: s, top_discard: n }) => {
            document.getElementById("discard-img-id").src = _t + n;
          }
        ),
        bt.on(
          gt.DRAW_CARD,
